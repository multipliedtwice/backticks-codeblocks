...
const __1 = require("..");
const fuzz_1 = require("../fuzz/fuzz");
describe('processText', () => {
    it('should convert block code to preformatted text', () => {
        ...
        const actualSegments = (0, __1.processText)(input);
    ...
    it('handles consecutive code blocks', () => {
        ...
        expect((0, __1.processText)(input)).toEqual(expectedSegments);
    });
